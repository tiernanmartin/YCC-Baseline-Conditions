...
Upper-right is the `nc_aggr`, which has been tranformed with `summarise()` which aggregates some counties together (also notice that the lack of CRS is visually apparent).
